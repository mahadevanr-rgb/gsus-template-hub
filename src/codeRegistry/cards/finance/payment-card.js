...
export default function PaymentCard({
  ...
  const maskedCardNumber = \`â€¢â€¢â€¢â€¢ â€¢â€¢â€¢â€¢ â€¢â€¢â€¢â€¢ \${safeLast4}\`;
      ...
      <div className="space-y-4">
        ...
        <div className="bg-[#1e293b] text-white rounded-2xl p-5 shadow-inner space-y-5 border border-slate-800 relative overflow-hidden">
          <div className="flex items-center justify-between text-xs font-semibold text-slate-300">
            <span>{brand} â€¢â€¢â€¢â€¢ {safeLast4}</span>
...
export default {
  ...
  slug: "payment-card",
  name: "Payment Card",
  description: "Secure payment method card displaying credit card brand, masked number, cardholder, expiry, and active status.",
  category: "cards",
  subCategory: "finance",
  framework: "react",
  language: "javascript",
  ...
  version: "1.0.0",
  dependencies: [],
  tags: ["payment", "credit-card", "visa", "billing", "finance", "masked", "wallet", "method"],
  author: "TemplateHub",
  createdAt: "2025-05-12",
  updatedAt: "2025-05-12",
  files: [
    { path: "components/ui/cards/PaymentCard.jsx", type: "component" },
  ],
  uses: [
    "Customer billing & payment method settings",
    "Checkout payment method selection",
    "Digital wallet card previews",

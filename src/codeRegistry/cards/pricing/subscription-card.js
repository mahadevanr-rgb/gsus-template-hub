...
export default function SubscriptionCard({
  ...
  return (
    <div
      className={\`relative bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-md overflow-hidden max-w-md w-full flex flex-col justify-between transition-all \${className}\`}
    >
      <div>
        {/* Top Header */}
      ...
      <div className="px-6 pb-6 pt-3 flex items-center justify-between gap-3 border-t border-slate-100/80 dark:border-slate-800/80 mt-auto">
        <button
          onClick={onCancel}
...
export default {
  ...
  description: "Communicates an existing subscription, renewal cycle, team seat allocation, and plan management actions.",
  category: "cards",
  subCategory: "pricing",
  framework: "react",
  language: "javascript",
  ...
  version: "1.0.0",
  dependencies: [],
  tags: ["subscription", "billing", "account", "renewal", "plan", "seats", "active"],
  author: "TemplateHub",
  createdAt: "2025-05-12",
  updatedAt: "2025-05-12",
  files: [
    { path: "components/ui/cards/SubscriptionCard.jsx", type: "component" },
  ],
  uses: [
    "Billing & account settings",
    "Customer subscription portal",
    "Usage & team seat allocation overview",
    "Renewal reminders",
  ],

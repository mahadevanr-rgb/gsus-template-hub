...
/**
 * NotificationCard
 * Clean, data-driven notification card for user or system activity feeds.
 * Supports distinct icon/avatar backgrounds, status states, relative timestamps, and unread indicators.
 */
export default function NotificationCard({
  ...
  return (
    <Card className={`max-w-sm w-full overflow-hidden ${className}`}>
      ...
      <CardContent className="p-3 sm:p-4 pt-1 space-y-1">
